...
//import Mail from '../Validations/Mail';
...
export default function Form() {
  ...
  const notificationSchema = yup.object().shape({
    ...
    //contactPhone: yup.string().matches(/^([9][1236\s])[0-9\s]*$/, "Please enter a valid phone number ex.(91 - 92 - 93 - 96)").required("A phone number is required").nullable(),
