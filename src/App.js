    ...
    <>
      <Router>
        ...
        <Routes>
          ...
          <Route
            path="/template/birthday"
            element={<Template content={"I want to wish you a funny and happy birthday!! See you soon!"} />}
          />
          <Route
            path="/template/position"
            element={<Template content={"Congratulations for your new position!! You´r going to be a great professional!"} />}
          />
          <Route
            path="/template/late"
            element={<Template content={"Today I´ll be late, don´t wait for me to dinner"} />}
          />
